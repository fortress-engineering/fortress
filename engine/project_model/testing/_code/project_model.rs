...
fn absolute_traversal_and_windows_binding_paths_are_rejected() {
    for path in ["C:/repo/src", "../src", "src\\payments"] {
        let source = format!(
            "{{\"$schema\":\"urn:fortress:schema:v3:project-configuration\",\"schema_version\":3,\"observation_exclusions\":[\".git\"],\"logical_modules\":[{{\"module\":\"AF-PAYMENTS-0001\",\"contract\":\"_data/logical_modules/payments/contract.json\",\"parent\":\"PF-PROJECT\",\"bindings\":[{{\"kind\":\"directory\",\"path\":{}}}]}}]}}",
...
fn equal_source_binding_authority_is_rejected_without_manifest_order() {
    let source = r#"{
      ...
      "observation_exclusions": [".git"],
      "logical_modules": [
        {"module": "AF-ALPHA-0001", "contract": "_data/logical_modules/alpha/contract.json", "parent": "PF-PROJECT", "bindings": [{"kind": "directory", "path": "src/shared"}]},
        {"module": "AF-BETA-0001", "contract": "_data/logical_modules/beta/contract.json", "parent": "PF-PROJECT", "bindings": [{"kind": "directory", "path": "src/shared"}]}
      ]
    }"#;
    assert!(matches!(
        ProjectConfiguration::from_json_str(source),
...
fn general_change_schema_does_not_require_bootstrap_provenance() {
    ...
    let source = fs::read_to_string(root.join("engine/project_model/_data/change_schema_v1.json"))
