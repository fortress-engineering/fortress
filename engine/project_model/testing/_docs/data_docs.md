...
### [`path_boundary.json`](../_data/path_boundary.json)

Provides specification-authored boundary conformance data for path behavior.

### [`project_invalid.json`](../_data/project_invalid.json)

Provides specification-authored invalid conformance data for project behavior.

### [`project_valid.json`](../_data/project_valid.json)

Provides specification-authored valid conformance data for project behavior.
