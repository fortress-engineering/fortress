...
fn semantic_conformance_execution(
    ...
    (
        RuleExecution {
            ...
            findings: findings.len(),
            detail: format!(
                "Module semantic policy recorded {} authored authorization(s), including {} with supported observed usage across {} matched observation(s), and evaluated {} DENY claim(s) from {} authored policy set(s); DENY evaluation produced {} block-supported and {} advisory raw contradiction(s), including {} test-only and {} unknown-provenance advisory claim(s), and retained {} claim-relative not-evaluable finding(s), including {} claim(s) with NO_SEMANTIC_COVERAGE. Authorizations do not discharge conformance obligations, and undeclared policy or zero semantic coverage is never interpreted as permission.",
                ...
                summary.advisory_findings(),
                summary.test_only_advisory_claims(),
                summary.unknown_provenance_advisory_claims(),
