...
pub(crate) const PROGRAM_ENVIRONMENT_RULE_SOURCE: &str =
    include_str!("../_data/program_environment_rule.json");
pub(crate) const PROGRAM_RETRY_RULE_SOURCE: &str = include_str!("../_data/program_retry_rule.json");
pub(crate) const PROGRAM_RECOVERY_RULE_SOURCE: &str =
    include_str!("../_data/program_recovery_rule.json");
