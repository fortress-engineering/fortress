...
Dispatches supported arguments, invokes Engine audit, CCG, Intended BFG, PSM, semantic-domain, state/effect, and information-flow behavior, renders output, and assigns process status.
