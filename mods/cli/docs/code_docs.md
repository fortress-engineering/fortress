...
Dispatches supported arguments, invokes Engine audit, CCG, Intended BFG, PSM, semantic-domain, state/effect, information-flow, and environmental behavior, renders output, and assigns process status.
