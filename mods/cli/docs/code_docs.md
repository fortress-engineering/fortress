...
Dispatches supported arguments, invokes Engine audit, CCG, Intended BFG, PSM, semantic-domain, and state/effect behavior, renders output, and assigns process status.
