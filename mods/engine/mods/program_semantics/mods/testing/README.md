...
Verification of authored architecture, intended behavior, function correctness, refinement domains, effects, realized behavior, and semantic classes deliberately unsupported by the current PSM.
