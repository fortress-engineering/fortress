...
Stable entity and rule identity syntax, common schema vocabulary, standard and schema manifests, rule metadata, satisfiable rule-logic declarations, and the mutable 1.0.0-draft.1 authority.
