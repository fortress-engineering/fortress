...
Orchestrates declaration loading, stabilized snapshot construction, shared CCG, Intended BFG, implementation, PSM, and semantic-domain analysis, rule execution, and deterministic audit v2 rendering with normative findings, non-normative architecture diagnostics, and unsupported analysis kept distinct.
...
Dispatches only implemented applicable rules, including PROGRAM-DOMAIN-001 from the shared semantic result, and distinguishes evaluated pass or failure from unsupported capability.
