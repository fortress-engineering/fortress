...
Loads canonical distributed Function Contract v3 sources, enforces symbol ownership and static-type compatibility for value domains, preserves state/effect and information-flow obligations for downstream owners, and computes their input digest.
