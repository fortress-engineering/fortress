...
The crate facade, package contract, and integration of standard registry, project model, repository observation, architecture evaluation, and Snapshot Governance capabilities.
