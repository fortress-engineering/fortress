...
Defines the warnings-denied provider-independent crate facade and composes child capability source, including Semantic Analysis, through explicit target paths.
