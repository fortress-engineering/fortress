...
Defines the warnings-denied provider-independent crate facade and composes child capability source, including Reference Resolution, Source Architecture, and State and Effect Analysis, through explicit crate-root resolution paths.
